...
#define NODE_MAIN_LOGGER_NAME "navigate_to_pose_action_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<action_tutorials_cpp::NavigateToPoseActionClient>";
